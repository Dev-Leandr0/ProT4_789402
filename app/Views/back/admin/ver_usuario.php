  ...
  <div class="card shadow-sm border-0">
    ...
    <div class="card-footer bg-light">
      <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url('admin') ?>" class="btn btn-outline-primary btn-sm px-4">
          Volver
        </a>

        <!-- Botón para editar al usuario actual -->
        <a href="<?= base_url('admin/editar/' . $usuario['id_usuario']) ?>" class="btn btn-outline-primary btn-sm px-4">
          Editar
        </a>
